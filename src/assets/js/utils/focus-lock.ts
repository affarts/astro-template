...
function disableExternalElements(element: HTMLElement): void {
  const allFocusableElements = document.body.querySelectorAll(
    selectors.join(',')
  )
  allFocusableElements.forEach((el: HTMLElement) => {
...
function enableExternalElements(): void {
